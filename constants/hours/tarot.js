...
const HOUR_TAROT_DESCRIPTIONS = {
  ...
  [HOUR_NAMES.THUNDERSKIN]: "The Emperor is a card that embodies leadership, stability, and paternal authority. The Thunderskin stresses the protective/relentless traits of the Emperor. Self-sacrificial, he \"beats to protect the skin of the world\" and is called upon to heal wounds/vanquish curses.",
  ...
  [HOUR_NAMES.SUN_IN_RAGS]: "The Hanged Man is a figure of willful sacrifice, surrendering himself to attain new perspective and wisdom. As the heir-apparent of the dead Sun, the Sun-in-Rags is a sacrificial figure - literally divided.\nSee the world differently. And when the blood drips down into your eyes, see the beauty in its colours.",
  ...
  [HOUR_NAMES.MOTHER_OF_ANTS]: "The Hierophant mandates belief, conformity, and spiritual wisdom. The Mother of Ants, interestingly, seems more thematically connected to the Hierophant Reversed: rebellion, new ways, unconformity. She helped overthrow the Stone Hours, opening the way for mortals to ascend.",
  ...
  [HOUR_NAMES.WOLF_DIVIDED]: "The Tower foretells the collapse of ambitions and established conceptions of life, drawing attention to the faulty ideals upon which they were built. There is almost nothing redeeming about the Wolf-Divided, as he embodies the violent upheaval of the card more than anything else. An abrupt, radical change is coming. You may not like it.",
