...
const HOUR_DESCRIPTIONS = {
  ...
  [HOUR_NAMES.COLONEL]: `The ${HOUR_NAMES.COLONEL}, who is blind, who is scarred; who cannot be denied. His scars make him impossible to wound.\nIn violence and rivalry, the ${HOUR_NAMES.COLONEL} prefers patience and cunning, and he favors those who promote the political status quo and betray revolutions.`,
  [HOUR_NAMES.LIONSMITH]: `The nature of the ${HOUR_NAMES.LIONSMITH} is to be stronger; to be seamless; to make monsters. The Lionsmith once shattered his sword with his bare hands; betraying and starting a legendary rivalry with the ${HOUR_NAMES.COLONEL}.\nThe ${HOUR_NAMES} is a furious Hour of strength, rebellion, and growing ever stronger.`,
  [HOUR_NAMES.ELEGIAST]: `The world forgets; but the Ivory Dove does not. The ${HOUR_NAMES.ELEGIAST} commemorates and grieves, and is heavily associated with memory, loss and death. While not the kindest of the Hours, he is never cruel - and remembers all his promises. He is the power which prevents the world from forgetting the lost.\nHe calls each of the Dead by name; he cannot be deceived.`,
  ...
  [HOUR_NAMES.GIRIBRAGO]: `He contains; He brings gifts; he does not destroy.\nThe ${HOUR_NAMES.GIRIBRAGO} is an obscure Hour of which little is known, who might be cast down into Nowhere.. Or to some decree, has replaced parts of the Sun. The ${HOUR_NAMES.GIRIBRAGO} is said to have "burst forth from the mountains", being Stone, Diamond, and emanating a powerful aura of life.`,
  ...
  [HOUR_NAMES.FLINT]: `The ${HOUR_NAMES.FLINT} was one of the old gods-from-stone worshipped before humanity. She is described as a smooth stone sharpened to a midnight point, whose facets glint with light. It seems to have filled a similar role to the ${HOUR_NAMES.FORGE_OF_DAYS}; which killed her. She invented the arts of shaping and remaking, and carries the proto-connection to fire.`,
