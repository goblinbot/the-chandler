...
const ASPECT_DESCRIPTIONS = {
  ...
  [ASPECT_NAMES.NECTAR]: {
    ...
    expanded:
      "Nectar as a power overlaps a fair bit with more standard principles; It is untamed like Moth. It is invigorating like Heart. It is intoxicating like Grail. It is commonly associated not only with plants, tees and wildlife, but also sacrifice, sustenance, and life. Usually in am ore primordial fashion.",
  },
  [ASPECT_NAMES.ROSE]: {
    short:
